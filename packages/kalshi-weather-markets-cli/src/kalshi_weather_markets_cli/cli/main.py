...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  The JSON payload includes `city`, `series_ticker`, `series_title`,\n"
            "  `event_ticker`, `event_date_label`, and `markets[]`.\n"
            "  `markets[]` contains the full active ladder for the selected daily event,\n"
